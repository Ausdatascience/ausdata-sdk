...
function AusdataUIContent({
  ...
  return /* @__PURE__ */ jsx("div", { className: `app-root ${themeClass} ${className ?? ""}`, style, children: /* @__PURE__ */ jsxs("div", { className: "business-search", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "business-search-panel", children: [
      /* @__PURE__ */ jsxs("div", { className: "business-accordion-item", children: [
        /* @__PURE__ */ jsxs(
          "button",
          {
            type: "button",
            ...
            children: [
              /* @__PURE__ */ jsx("span", { className: "business-accordion-title", children: "Search Business" }),
              /* @__PURE__ */ jsx("span", { className: `business-accordion-icon ${accordionExpanded.search ? "expanded" : ""}`, children: /* @__PURE__ */ jsx("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ jsx("path", { d: "M4 6L8 10L12 6", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) }) })
            ]
          }
        ),
        /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsx("form", { onSubmit: handleSearch, className: "business-search-form", children: /* @__PURE__ */ jsxs("label", { className: "business-search-label", children: [
      ...
      showControlPanel && /* @__PURE__ */ jsxs("div", { className: "business-accordion-item", children: [
        /* @__PURE__ */ jsxs(
          "button",
          {
            type: "button",
            ...
            children: [
              /* @__PURE__ */ jsx("span", { className: "business-accordion-title", children: "Display Settings" }),
              /* @__PURE__ */ jsx("span", { className: `business-accordion-icon ${accordionExpanded.controls ? "expanded" : ""}`, children: /* @__PURE__ */ jsx("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ jsx("path", { d: "M4 6L8 10L12 6", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) }) })
            ]
          }
        ),
        /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "business-style-controls", children: [
                ...
                /* @__PURE__ */ jsx(
                  "select",
                  {
                    ...
                    children: THEMES.map((theme) => {
                      ...
                      return /* @__PURE__ */ jsx("option", { value: theme, children: label }, theme);
                    })
                  }
                )
              ] }),
    ...
    total > 0 && /* @__PURE__ */ jsx("div", { className: "business-search-meta", children: /* @__PURE__ */ jsxs("span", { children: [
      "Showing ",
    ...
    results.length > 0 && /* @__PURE__ */ jsxs("section", { className: "business-search-results", children: [
      ...
      ] }) }) : variant === "card" ? /* @__PURE__ */ jsx("div", { className: "business-card-grid", children: results.map((biz, index) => {
        const statusKey = (biz.status || "").toLowerCase();
        const statusClass = statusKey === "active" ? "status-active" : statusKey === "cancelled" || statusKey === "inactive" ? "status-cancelled" : "";
      ...
      }) }) : /* @__PURE__ */ jsx("div", { className: "business-list", children: results.map((biz, index) => {
        const statusKey = (biz.status || "").toLowerCase();
        const statusClass = statusKey === "active" ? "status-active" : statusKey === "cancelled" || statusKey === "inactive" ? "status-cancelled" : "";
        return /* @__PURE__ */ jsx("div", { className: "business-list-item", children: /* @__PURE__ */ jsxs("div", { className: "business-list-main", children: [
          /* @__PURE__ */ jsxs("div", { className: "business-list-name-row", children: [
            /* @__PURE__ */ jsx(
              "div",
              {
            ...
            /* @__PURE__ */ jsxs("div", { className: "business-list-badges", children: [
              /* @__PURE__ */ jsx("span", { className: `business-badge ${statusClass}`, children: biz.status || "Unknown" }),
              biz.type && /* @__PURE__ */ jsx("span", { className: "business-badge", children: biz.type === "IND" ? "Individual" : biz.type === "CO" ? "Company" : biz.type })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "business-list-details", children: [
            /* @__PURE__ */ jsxs("span", { className: "business-list-abn", children: [
              "ABN ",
              biz.abn
            ] }),
            biz.industry && /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx("span", { className: "business-list-separator", children: "\u2022" }),
              /* @__PURE__ */ jsx("span", { className: "business-list-industry", children: biz.industry })
            ] }),
            /* @__PURE__ */ jsx("span", { className: "business-list-separator", children: "\u2022" }),
            /* @__PURE__ */ jsx("span", { className: "business-list-location", children: biz.address ? biz.address : `${biz.state ?? ""} ${biz.postcode ?? ""}`.trim() })
          ] })
        ] }) }, `${biz.abn}-${index}`);
      }) })
    ] }),
    showDetailModal && selectedBusiness && /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "business-detail-modal-header", children: [
                /* @__PURE__ */ jsx("h2", { id: "business-detail-title", children: selectedBusiness.name }),
                /* @__PURE__ */ jsx(
                  "button",
                  {
              ...
              /* @__PURE__ */ jsxs("div", { className: "business-detail-modal-content", children: [
                /* @__PURE__ */ jsxs("div", { className: "business-detail-section", children: [
                  /* @__PURE__ */ jsx("h3", { children: "Basic Information" }),
                  /* @__PURE__ */ jsxs("div", { className: "business-detail-grid", children: [
                    /* @__PURE__ */ jsxs("div", { className: "business-detail-item", children: [
                      /* @__PURE__ */ jsx("span", { className: "business-detail-label", children: "ABN" }),
                      /* @__PURE__ */ jsx("span", { className: "business-detail-value", children: selectedBusiness.abn })
                    ] }),
                    /* @__PURE__ */ jsxs("div", { className: "business-detail-item", children: [
                      /* @__PURE__ */ jsx("span", { className: "business-detail-label", children: "Status" }),
                      /* @__PURE__ */ jsx("span", { className: `business-badge ${(selectedBusiness.status || "").toLowerCase() === "active" ? "status-active" : ""}`, children: selectedBusiness.status || "Unknown" })
                    ] }),
                    /* @__PURE__ */ jsxs("div", { className: "business-detail-item", children: [
                      /* @__PURE__ */ jsx("span", { className: "business-detail-label", children: "Type" }),
                      /* @__PURE__ */ jsx("span", { className: "business-detail-value", children: selectedBusiness.type === "IND" ? "Individual" : selectedBusiness.type === "CO" ? "Company" : selectedBusiness.type || "\u2014" })
                    ] }),
                    selectedBusiness.industry && /* @__PURE__ */ jsxs("div", { className: "business-detail-item", children: [
                      /* @__PURE__ */ jsx("span", { className: "business-detail-label", children: "Industry" }),
                      /* @__PURE__ */ jsx("span", { className: "business-detail-value", children: selectedBusiness.industry })
                    ] })
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "business-detail-section", children: [
                  /* @__PURE__ */ jsx("h3", { children: "Location" }),
                  /* @__PURE__ */ jsxs("div", { className: "business-detail-grid", children: [
                    selectedBusiness.address && /* @__PURE__ */ jsxs("div", { className: "business-detail-item business-detail-item-full", children: [
                      /* @__PURE__ */ jsx("span", { className: "business-detail-label", children: "Address" }),
                      /* @__PURE__ */ jsx("span", { className: "business-detail-value", children: selectedBusiness.address })
                    ] }),
                    /* @__PURE__ */ jsxs("div", { className: "business-detail-item", children: [
                      /* @__PURE__ */ jsx("span", { className: "business-detail-label", children: "State" }),
                      /* @__PURE__ */ jsx("span", { className: "business-detail-value", children: selectedBusiness.state || "\u2014" })
                    ] }),
                    /* @__PURE__ */ jsxs("div", { className: "business-detail-item", children: [
                      /* @__PURE__ */ jsx("span", { className: "business-detail-label", children: "Postcode" }),
                      /* @__PURE__ */ jsx("span", { className: "business-detail-value", children: selectedBusiness.postcode || "\u2014" })
                    ] })
                  ] })
                ] }),
                (selectedBusiness.gst || selectedBusiness.businessNames || selectedBusiness.score !== void 0) && /* @__PURE__ */ jsxs("div", { className: "business-detail-section", children: [
                  /* @__PURE__ */ jsx("h3", { children: "Additional Information" }),
                  /* @__PURE__ */ jsxs("div", { className: "business-detail-grid", children: [
                    selectedBusiness.gst && /* @__PURE__ */ jsxs("div", { className: "business-detail-item business-detail-item-full", children: [
                      /* @__PURE__ */ jsx("span", { className: "business-detail-label", children: "GST" }),
                      /* @__PURE__ */ jsx("span", { className: "business-detail-value", children: selectedBusiness.gst })
                    ] }),
                    selectedBusiness.businessNames && selectedBusiness.businessNames.length > 0 && /* @__PURE__ */ jsxs("div", { className: "business-detail-item business-detail-item-full", children: [
                      /* @__PURE__ */ jsx("span", { className: "business-detail-label", children: "Trading Names" }),
                      /* @__PURE__ */ jsx("div", { className: "business-detail-value", children: selectedBusiness.businessNames.map((name, idx) => /* @__PURE__ */ jsx("span", { className: "business-detail-badge", children: name }, idx)) })
                    ] }),
                    selectedBusiness.score !== void 0 && /* @__PURE__ */ jsxs("div", { className: "business-detail-item", children: [
                      /* @__PURE__ */ jsx("span", { className: "business-detail-label", children: "Match Score" }),
                      /* @__PURE__ */ jsx("span", { className: "business-detail-value", children: selectedBusiness.score })
                    ] }),
                    selectedBusiness.abnStatus && /* @__PURE__ */ jsxs("div", { className: "business-detail-item", children: [
                      /* @__PURE__ */ jsx("span", { className: "business-detail-label", children: "ABN Status" }),
                      /* @__PURE__ */ jsx("span", { className: "business-detail-value", children: selectedBusiness.abnStatus })
                    ] })
                  ] })
                ] })
              ] })
